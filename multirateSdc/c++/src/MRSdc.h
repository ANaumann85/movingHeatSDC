...
struct Collocation
{
	typedef mtl::dense2D<double > Mat;
...
struct MultirateCollocation
{
	...
	{
		Shat_mp = {{ 0.33333333 , 0.        },
			{ 0.66666667,  0.        }};

		S_mnp[0]={{ 0.22916667,  0.1875    },
			{-0.0625  ,   -0.02083333}};
		S_mnp[1]={{ 0.25   ,     0.08333333},
			{ 0.08333333 , 0.25      }};
		...
		coll_sub[0].sMat={{ 0.   ,       0.     ,     0.        },
			{ 0.  ,        0.25   ,    -0.08333333},
			{ 0.  ,        0.08333333 , 0.08333333}};

		coll_sub[1].sMat= {{ 0.    ,      0.    ,      0.        },
			{ 0.  ,        0.5   ,     -0.16666667},
	...
	{
		setValue(iVal, 0.0);
		const Mat& sMat(coll_sub[m].sMat);
