...
set output "cmpAccuracy_sdc_ros2_alpha_1e-3.pdf"
...
ros2File="ros2_alpha_1e-3/accuracy.dat"
...
mrLaplTildeHFo='mrsdc_alpha_1e-3_laplTilde_h/kiter_%d/accuracy_M_%s_P_%s.dat'
mrLaplTildeH2Fo='mrsdc_alpha_1e-3_laplTilde_h2/kiter_%d/accuracy_M_%s_P_%s.dat'
...
plot for [M in "2 3"] for [P in "2 3 6 8"] sprintf('mrsdc_alpha_1e-3/kiter_%d/accuracy_M_%s_P_%s.dat',k_iter,M,P) u 5:3 w lp lc rgbcolor word(sdcCol,P+0) pt (M+1) title sprintf('mrsdc-M%s-P%s-kiter%d', M,P, k_iter), "ros2_alpha_1e-3/accuracy.dat" u 5:3 w l lc rgbcolor 'orange' lw 4 t "ros2", for [M in "2 3"] sprintf(sdcFo,k_iter,M) u 5:3 w lp lc rgbcolor word(sdcCol,1) pt (M+1) title sprintf('sdc-M%s-kiter%d', M, k_iter),
...
plot for [M in "2 3"] for [P in "2 3 6 8"] sprintf(mrLaplTildeHFo,k_iter,M,P) u 5:3 w lp lc rgbcolor word(sdcCol,P+0) pt (M+1) title sprintf('mrsdc-M%s-P%s-kiter%d-Lapl\~h', M,P, k_iter), "ros2_alpha_1e-3/accuracy.dat" u 5:3 w l lc rgbcolor 'orange' lw 4 t "ros2", for [M in "2 3"] sprintf(sdcLapl0Fo,k_iter,M) u 5:3 w lp lc rgbcolor word(sdcCol,1) pt (M+1) title sprintf('sdc-M%s-kiter%d-Lapl_{0}', M, k_iter),

plot for [M in "2 3"] for [P in "2 3 6 8"] sprintf(mrLaplTildeH2Fo,k_iter,M,P) u 5:3 w lp lc rgbcolor word(sdcCol,P+0) pt (M+1) title sprintf('mrsdc-M%s-P%s-kiter%d-Lapl\~h^2', M,P, k_iter), "ros2_alpha_1e-3/accuracy.dat" u 5:3 w l lc rgbcolor 'orange' lw 4 t "ros2", for [M in "2 3"] sprintf(sdcLapl0Fo,k_iter,M) u 5:3 w lp lc rgbcolor word(sdcCol,1) pt (M+1) title sprintf('sdc-M%s-kiter%d-Lapl_{0}', M, k_iter),
