...
mrFoLaplV2h='mrsdc_laplTilde_V2_h/kiter_%d/accuracy_M_%s_P_%s.dat'
...
plot for [M in "2 3"] for [P in "2 4 8"] sprintf(mrFoLaplV2h,k_iter,M,P) u (20.0/$1):3 w lp lc rgbcolor word(sdcCol,P+0) pt (M+0) title sprintf('mrsdcLaplV2\~h-M%s-P%s-kiter%d', M,P,k_iter), ros2File u (20.0/$1):3 w l lc rgbcolor 'orange' t "ros2", for [M in "2 3"] sprintf(sdcFo,k_iter,M) u (20.0/$1):3 w lp lc rgbcolor word(sdcCol,1) pt (M+0) title sprintf('sdc-M%s-kiter%d', M,k_iter), rkcFile u 4:3 w l dt rkcDash lw 2 lc rgbcolor rkcColor t rkcName
...
plot for [M in "2 3"] for [P in "2 4 8"] sprintf(mrFoLaplV2h,k_iter,M,P) u (20.0/$1):3 w lp lc rgbcolor word(sdcCol,P+0) pt (M+0) title sprintf('mrsdcLaplV2\~h-M%s-P%s-kiter%d', M,P,k_iter),for [M in "2 3"] for [P in "2 4"] sprintf(mrFoSrc,k_iter,M,P) u (20.0/$1):3 w l dt 2 lc rgbcolor word(sdcCol,P+0) title sprintf('mrsdc-M%s-P%s-kiter%d', M,P,k_iter), rkcFile u 4:3 w l dt rkcDash lw 2 lc rgbcolor rkcColor t rkcName
...
plot for [M in "2 3"] for [P in "2 4"] sprintf(mrFoLaplV2h,k_iter,M,P) u 5:3 w lp lc rgbcolor word(sdcCol,P+0) pt (M+1) title sprintf('mrsdcLaplV2\~h-M%s-P%s-kiter%d', M,P, k_iter), ros2File u 5:3 w l lc rgbcolor 'orange' lw 4 t "ros2", for [M in "2 3"] sprintf(sdcFo,k_iter,M) u 5:3 w lp lc rgbcolor word(sdcCol,1) pt (M+1) title sprintf('sdc-M%s-kiter%d', M, k_iter), rkcFile u 5:3 w l dt rkcDash lw 2 lc rgbcolor rkcColor t rkcName,
